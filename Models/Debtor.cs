...
public class Debtor
{
    ...
    public static List<Debtor> getdebtors() => new List<Debtor> {
            ...
            new Debtor("Roy D. Green", DateTime.Parse("January 27, 1983"), "308-380-5981", "RoyDGreen@jourrapide.com", "401 Romrog Way Grand Island, NE 68801", 10771),
            ...
            new Debtor("Pamela H. Beauchamp", DateTime.Parse("November 20, 2959"), "801-559-6347", "PamelaHBeauchamp@jourrapide.com", "3239 Tori Lane Salt Lake City, UT 84104", 6588)
        };
